...
public class CustomWorkItemHandlerClient implements Runnable {
    ...
    private final static String PROCESS_ID = "jpaPlaceholderMarshalling";
    ...
    public void run() {
            ...
            if(SyncClientTest.includeProcessVariables) {
                ...
                cObj.setId(randomLong);
                parameters.put("customer", cObj);
            }
            ...
            for(counter=1; counter <= SyncClientTest.requestsPerClient; counter++) {
                ...
                if(SyncClientTest.startNewProcessInstance) {
                    ...
                    try {
                        ...
                        Thread.sleep(5);
                        String pVariables = kSessionProxy.printActiveProcessInstanceVariables(processInstanceId, ksessionId);
                        log.info("run() pVariables = \n"+pVariables);
